...
if __name__ == '__main__':
    splines = [Spline(CheckedList[GVector]([GVector(1.59735, 3.30446, 0.0), GVector(1.57581, 4.12326, 0.0), GVector(1.31321, 5.28835, 0.0), GVector(1.6189, 5.32991, 0.0), GVector(2.88994, 5.5027, 0.0), GVector(2.37306, 4.38183, 0.0), GVector(1.662, 4.36028, 0.0)]), 3, CheckedList[int]([0, 0, 0, 1, 1, 1, 2, 2, 2])), Spline(CheckedList[GVector]([GVector(2.8045, 4.01735, 0.0), GVector(2.5505, 3.52523, 0.0), GVector(1.97901, 2.62036, 0.0), GVector(1.97901, 2.62036, 0.0)]), 3, CheckedList[int]([0, 0, 0, 1, 1, 1])), Spline(CheckedList[GVector]([GVector(2.00167, 4.01132, 0.0), GVector(2.33504, 3.31283, 0.0), GVector(2.3668, 3.23346, 0.0), GVector(2.3668, 3.23346, 0.0)]), 3, CheckedList[int]([0, 0, 0, 1, 1, 1]))]
    startTime = time.time()
