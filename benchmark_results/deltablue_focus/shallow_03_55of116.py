...
class Strength(object):
    ...
    def __init__(self, strength: int, name):
...
class Variable(object):
    ...
    def remove_constraint(self, constraint: EditConstraint):
...
class Planner(object):
    ...
    def add_propagate(self, c, mark: int) -> bool:
    ...
    def add_constraints_consuming_to(self, v, coll: OrderedCollection) -> None:
