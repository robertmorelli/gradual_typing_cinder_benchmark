...
class BinaryConstraint(Constraint):
    ...
    def choose_method(self, mark):
        if int64(self.v1.mark) == int64(mark):
            if int64(self.v2.mark) != int64(mark) and stronger(self.strength, self.v2.walk_strength):
    ...
    def inputs_known(self, mark):
        ...
        return box(cbool(int64(i.mark) == int64(mark) or i.stay or cbool(cast(Constraint | None, i.determined_by) is None)))
...
class ScaleConstraint(BinaryConstraint):
    ...
    def __init__(self, src, scale: Variable, offset, dest: Variable, strength: Strength):
