...
class BinaryConstraint(Constraint):
    ...
    def choose_method(self, mark):
        if cast(Variable, self.v1).mark == int64(mark):
            if self.v2.mark != int64(mark) and stronger(cast(Strength, self.strength), self.v2.walk_strength):
    ...
    def recalculate(self):
        ...
        out.walk_strength = cast(Strength, weakest_of(cast(Strength, self.strength), cast(Variable, ihn).walk_strength))
    ...
    def inputs_known(self, mark):
        ...
        return box(cbool(i.mark == int64(mark) or cbool(i.stay) or cbool(cast(Constraint | None, i.determined_by) is None)))
