...
class ScaleConstraint(BinaryConstraint):
    ...
    def execute(self):
        if self.direction == Direction.FORWARD:
            self.v2.value = box(int64(int64(self.v1.value) * int64(self.scale.value) + int64(cast(Variable, self.offset).value)))
        else:
            self.v1.value = box(int64((int64(self.v2.value) - int64(cast(Variable, self.offset).value)) / int64(self.scale.value)))
