...
def create_array(start, end, step) -> Array[int64]:
    ...
    size: int64 = int64((static_abs(int64(end) - int64(start)) - 1) / static_abs(step) + 1)
...
def permutations(pool: Array[int64], r=-1) -> Iterator[Array[int64]]:
    ...
    if int64(r) == -1:
        r = box(n)
    rb = r
    indices: Array[int64] = create_array(0, box(int64(n)), 1)
    cycles: Array[int64] = create_array(box(int64(n)), box(int64(n - int64(r))), box(int64(-1)))
