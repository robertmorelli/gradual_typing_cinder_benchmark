...
class Task(TaskState):
    ...
    def __init__(self, i: int64, p: int64, w, initialState: TaskState, r: TaskRec) -> None:
...
class DeviceTask(Task):
    ...
    def __init__(self, i: int64, p: int64, w, s: TaskState, r: DeviceTaskRec) -> None:
...
class HandlerTask(Task):
    ...
    def __init__(self, i: int64, p: int64, w, s: TaskState, r: HandlerTaskRec) -> None:
        Task.__init__(self, i, p, w, s, r)
...
class IdleTask(Task):
    ...
    def __init__(self, i: int64, p: int64, w, s: TaskState, r: IdleTaskRec) -> None:
...
class WorkTask(Task):
    ...
    def __init__(self, i: int64, p: int64, w, s: TaskState, r: WorkerTaskRec) -> None:
        Task.__init__(self, i, p, w, s, r)
