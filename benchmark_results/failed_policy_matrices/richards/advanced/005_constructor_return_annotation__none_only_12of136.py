...
class Task(TaskState):
    ...
    def __init__(self, i: int64, p: int64, w: Optional[Packet], initialState: TaskState, r: TaskRec):
...
class DeviceTask(Task):
    ...
    def __init__(self, i: int64, p: int64, w: Optional[Packet], s: TaskState, r: DeviceTaskRec):
...
class HandlerTask(Task):
    ...
    def __init__(self, i: int64, p: int64, w: Packet, s: TaskState, r: HandlerTaskRec):
        Task.__init__(self, i, p, w, s, r)
...
class IdleTask(Task):
    ...
    def __init__(self, i: int64, p: int64, w: int, s: TaskState, r: IdleTaskRec):
...
class WorkTask(Task):
    ...
    def __init__(self, i: int64, p: int64, w: Packet, s: TaskState, r: WorkerTaskRec):
        Task.__init__(self, i, p, w, s, r)
