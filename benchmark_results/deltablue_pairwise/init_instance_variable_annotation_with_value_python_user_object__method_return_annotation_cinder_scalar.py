...
class Constraint(object):
    ...
    def inputs_known(self, mark: int64):
...
class BinaryConstraint(Constraint):
    ...
    def inputs_known(self, mark: int64):
        i = self.input()
        return box(cbool(i.mark == mark or i.stay or cbool(cast(Constraint | None, i.determined_by) is None)))
...
class Planner(object):
    ...
    def make_plan(self, sources: CheckedList[UrnaryConstraint]) -> Plan:
        ...
        while clen(todo):
            c = todo.pop(0)
            if c.output().mark != mark and cbool(c.inputs_known(mark)):
    ...
    def add_propagate(self, c: Constraint, mark: int64):
