...
class GVector(object):
    ...
    def linear_combination(self, other: GVector, l1: float, l2: float):
        v = GVector(self.x * l1 + other.x * l2, self.y * l1 + other.y * l2, self.z * l1 + other.z * l2)
        return cast(GVector, v)

class Spline(object):

    def __init__(self, points: CheckedList[GVector], degree, knots) -> None:
        if knots == None:
...
class Chaosgame(object):
    ...
    def __init__(self, splines: List[Spline], thickness, w, h, n) -> None:
...
if __name__ == '__main__':
    splines = [Spline([GVector(1.59735, 3.30446, 0.0), GVector(1.57581, 4.12326, 0.0), GVector(1.31321, 5.28835, 0.0), GVector(1.6189, 5.32991, 0.0), GVector(2.88994, 5.5027, 0.0), GVector(2.37306, 4.38183, 0.0), GVector(1.662, 4.36028, 0.0)], 3, CheckedList[int]([0, 0, 0, 1, 1, 1, 2, 2, 2])), Spline([GVector(2.8045, 4.01735, 0.0), GVector(2.5505, 3.52523, 0.0), GVector(1.97901, 2.62036, 0.0), GVector(1.97901, 2.62036, 0.0)], 3, CheckedList[int]([0, 0, 0, 1, 1, 1])), Spline([GVector(2.00167, 4.01132, 0.0), GVector(2.33504, 3.31283, 0.0), GVector(2.3668, 3.23346, 0.0), GVector(2.3668, 3.23346, 0.0)], 3, CheckedList[int]([0, 0, 0, 1, 1, 1]))]
    startTime = time.time()
