...
class Record:
    ...
    def __init__(self, PtrComp=None, Discr: int=0, EnumComp: int=0, IntComp: int=0, StringComp='\x00'):
...
def Proc8(Array1Par, Array2Par, IntParI1: int, IntParI2) -> None:
    global IntGlob
    IntLoc = IntParI1 + 5
    cast(CheckedList[int], Array1Par)[IntLoc] = IntParI2
    cast(CheckedList[int], Array1Par)[IntLoc + 1] = cast(CheckedList[int], Array1Par)[IntLoc]
    cast(CheckedList[int], Array1Par)[IntLoc + 30] = IntLoc
    for IntIndex in range(IntLoc, IntLoc + 2):
        cast(CheckedList[CheckedList[int]], Array2Par)[IntLoc][IntIndex] = IntLoc
    cast(CheckedList[CheckedList[int]], Array2Par)[IntLoc][IntLoc - 1] = cast(CheckedList[CheckedList[int]], Array2Par)[IntLoc][IntLoc - 1] + 1
    cast(CheckedList[CheckedList[int]], Array2Par)[IntLoc + 20][IntLoc] = cast(CheckedList[int], Array1Par)[IntLoc]
    IntGlob = 5
