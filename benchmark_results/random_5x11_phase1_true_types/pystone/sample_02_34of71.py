...
class Record:
    ...
    def __init__(self, PtrComp: Record | None=None, Discr=0, EnumComp=0, IntComp: int=0, StringComp='\x00'):
...
def Proc8(Array1Par: CheckedList[int], Array2Par, IntParI1: int, IntParI2) -> None:
    global IntGlob
    IntLoc = IntParI1 + 5
    ...
    cast(CheckedList[CheckedList[int]], Array2Par)[IntLoc + 20][IntLoc] = Array1Par[IntLoc]
    IntGlob = 5
...
def Func2(StrParI1: str, StrParI2: str):
    IntLoc = 1
    CharLoc: str = ''
    while IntLoc <= 1:
