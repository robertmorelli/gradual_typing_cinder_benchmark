...
def create_array(start, end: int64, step) -> Array[int64]:
    """
    ...
    """
    c = box(int64(int64(start)))
    i: int64 = 0
    if (end - int64(start)) * int64(step) <= 0:
        return Array[int64](0)
    size = box(int64(int64((static_abs(box(int64(end - int64(start)))) - 1) / static_abs(box(int64(step))) + 1)))
...
def permutations(pool: Array[int64], r=-1) -> Iterator[Array[int64]]:
    n = clen(pool)
    if int64(r) == -1:
        r = box(n)
    rb = box(int64(r))
    indices: Array[int64] = create_array(box(int64(0)), n, box(int64(1)))
    cycles: Array[int64] = create_array(box(int64(n)), n - int64(r), box(int64(-1)))
...
def solve(queen_count) -> Iterator[Array[int64]]:
    ...
    static_cols = create_array(box(int64(0)), int64(queen_count), box(int64(1)))
