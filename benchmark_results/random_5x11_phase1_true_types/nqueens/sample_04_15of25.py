...
def create_array(start: int64, end, step):
    """
    ...
    size: int64 = int64((int64(static_abs(box(int64(int64(end) - start)))) - 1) / int64(static_abs(box(int64(step)))) + 1)
...
def permutations(pool, r=-1) -> Iterator[Array[int64]]:
    ...
    if int64(r) == -1:
        r = box(n)
    rb = box(int64(r))
    indices = create_array(0, box(int64(n)), box(int64(1)))
    cycles = create_array(n, box(int64(n - int64(r))), box(int64(-1)))
...
def solve(queen_count) -> Iterator[Array[int64]]:
    ...
    static_cols: Array[int64] = create_array(0, box(int64(queen_count)), box(int64(1)))
