...
class GVector:
    ...
    def linear_combination(self, other: GVector, l1, l2: float) -> GVector:
...
class Chaosgame:
    ...
    def __init__(self, splines: List[Spline], thickness: float, w, h, n) -> None:
