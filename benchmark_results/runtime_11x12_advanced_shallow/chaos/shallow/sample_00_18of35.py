...
class GVector:
    ...
    def __init__(self, x, y: float, z) -> None:
        self.x: float = x
        self.y = y
        self.z = z
    ...
    def linear_combination(self, other: GVector, l1, l2: float):
...
class Spline:
    ...
    def __init__(self, points: List[GVector], degree: int, knots):
...
class Chaosgame:
    ...
    def __init__(self, splines, thickness: float, w, h: int, n) -> None:
