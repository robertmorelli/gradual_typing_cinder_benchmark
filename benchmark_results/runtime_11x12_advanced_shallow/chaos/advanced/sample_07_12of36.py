...
class Spline(object):
    ...
    def __init__(self, points: CheckedList[GVector], degree, knots: CheckedList[int]) -> None:
        if knots == None:
...
class Chaosgame(object):
    ...
    def __init__(self, splines: List[Spline], thickness: float, w, h: int, n: int) -> None:
