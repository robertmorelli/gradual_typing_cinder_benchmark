...
class Record:
    ...
    def __init__(self, PtrComp: Record | None=None, Discr: int=0, EnumComp: int=0, IntComp: int=0, StringComp='\x00'):
...
def Proc8(Array1Par: CheckedList[int], Array2Par: CheckedList[CheckedList[int]], IntParI1, IntParI2):
    global IntGlob
    IntLoc = IntParI1 + 5
