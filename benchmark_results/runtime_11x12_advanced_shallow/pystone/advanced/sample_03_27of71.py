...
class Record:
    ...
    def __init__(self, PtrComp: Record | None=None, Discr=0, EnumComp=0, IntComp: int=0, StringComp: str='\x00'):
...
def Proc0(loops=LOOPS):
    ...
    for _i in range(loops):
        ...
        while IntLoc1 < IntLoc2:
            ...
            IntLoc1 = IntLoc1 + 1
        Proc8(Array1Glob, cast(CheckedList[CheckedList[int]], Array2Glob), IntLoc1, IntLoc3)
...
def Proc8(Array1Par: CheckedList[int], Array2Par, IntParI1: int, IntParI2: int) -> None:
    global IntGlob
    IntLoc = IntParI1 + 5
