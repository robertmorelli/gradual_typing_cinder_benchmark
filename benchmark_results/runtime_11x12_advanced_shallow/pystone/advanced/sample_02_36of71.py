...
class Record:
    ...
    def __init__(self, PtrComp=None, Discr: int=0, EnumComp: int=0, IntComp=0, StringComp: str='\x00'):
...
Char1Glob = '\x00'
Char2Glob = '\x00'
Array1Glob = cast(CheckedList[int], CheckedList[int]([0] * 51))
...
def Proc1(PtrParIn: Record):
    ...
    NextRecord.PtrComp = cast(Record | None, Proc3(NextRecord.PtrComp))
...
def Proc8(Array1Par: CheckedList[int], Array2Par, IntParI1, IntParI2: int):
    global IntGlob
    IntLoc = IntParI1 + 5
