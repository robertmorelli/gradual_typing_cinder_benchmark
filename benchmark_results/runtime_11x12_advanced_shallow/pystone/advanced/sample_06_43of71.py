...
class Record:
    ...
    def __init__(self, PtrComp: Record | None=None, Discr=0, EnumComp=0, IntComp=0, StringComp: str='\x00'):
...
Array2Glob = cast(CheckedList[CheckedList[int]], CheckedList[CheckedList[int]]([CheckedList[int](x) for x in [Array1Glob] * 51]))
...
def Proc0(loops=LOOPS):
    ...
    cast(CheckedList[int], Array2Glob[8])[7] = 10
    for _i in range(loops):
        Proc5()
        Proc4()
        IntLoc1 = 2
        ...
        while IntLoc1 < IntLoc2:
            ...
            IntLoc1 = IntLoc1 + 1
        Proc8(cast(CheckedList[int], Array1Glob), cast(CheckedList[CheckedList[int]], Array2Glob), IntLoc1, IntLoc3)
...
def Proc1(PtrParIn: Record):
    ...
    NextRecord.PtrComp = cast(Record | None, PtrParIn.PtrComp)
    NextRecord.PtrComp = Proc3(cast(Record | None, NextRecord.PtrComp))
...
def Proc7(IntParI1: int, IntParI2) -> int:
    IntLoc = IntParI1 + 2
...
def Proc8(Array1Par, Array2Par, IntParI1, IntParI2) -> None:
    ...
    for IntIndex in range(IntLoc, IntLoc + 2):
        cast(CheckedList[int], Array2Par[IntLoc])[IntIndex] = IntLoc
    cast(CheckedList[int], Array2Par[IntLoc])[IntLoc - 1] = cast(CheckedList[int], Array2Par[IntLoc])[IntLoc - 1] + 1
    cast(CheckedList[int], Array2Par[IntLoc + 20])[IntLoc] = Array1Par[IntLoc]
    IntGlob = 5
...
def Func2(StrParI1, StrParI2: str):
    IntLoc: int = 1
    CharLoc: str = ''
    while IntLoc <= 1:
