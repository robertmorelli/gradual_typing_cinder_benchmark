...
class Record:
    ...
    def __init__(self, PtrComp: Record | None=None, Discr: int=0, EnumComp=0, IntComp: int=0, StringComp='\x00'):
...
def Proc7(IntParI1, IntParI2) -> int:
    IntLoc = IntParI1 + 2
...
def Func1(CharPar1, CharPar2: str):
