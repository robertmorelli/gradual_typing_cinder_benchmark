...
class Record:
    ...
    def __init__(self, PtrComp=None, Discr=0, EnumComp=0, IntComp=0, StringComp: str='\x00'):
...
def Proc8(Array1Par: CheckedList[int], Array2Par: CheckedList[CheckedList[int]], IntParI1, IntParI2: int) -> None:
    global IntGlob
    IntLoc = IntParI1 + 5
...
def Func1(CharPar1: str, CharPar2) -> int:
    CharLoc1 = CharPar1
