...
class Record:
    ...
    def __init__(self, PtrComp=None, Discr=0, EnumComp: int=0, IntComp=0, StringComp: str='\x00'):
...
def Proc8(Array1Par: CheckedList[int], Array2Par: CheckedList[CheckedList[int]], IntParI1: int, IntParI2):
    global IntGlob
    IntLoc = IntParI1 + 5
