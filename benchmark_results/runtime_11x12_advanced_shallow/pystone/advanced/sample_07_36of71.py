...
class Record:
    ...
    def __init__(self, PtrComp: Record | None=None, Discr=0, EnumComp: int=0, IntComp: int=0, StringComp='\x00'):
...
def Proc0(loops=LOOPS):
    ...
    for _i in range(loops):
        ...
        while IntLoc1 < IntLoc2:
            ...
            IntLoc1 = IntLoc1 + 1
        Proc8(cast(CheckedList[int], Array1Glob), Array2Glob, IntLoc1, IntLoc3)
...
def Proc8(Array1Par, Array2Par: CheckedList[CheckedList[int]], IntParI1, IntParI2: int) -> None:
    global IntGlob
    IntLoc = IntParI1 + 5
