...
class Record:
    ...
    def __init__(self, PtrComp: Record | None=None, Discr=0, EnumComp: int=0, IntComp: int=0, StringComp: str='\x00'):
...
def Proc8(Array1Par: List[int], Array2Par: List[int], IntParI1, IntParI2: int) -> None:
    global IntGlob
    IntLoc = IntParI1 + 5
