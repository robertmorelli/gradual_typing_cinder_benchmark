...
class Record:
    ...
    def __init__(self, PtrComp: Record | None=None, Discr=0, EnumComp=0, IntComp=0, StringComp='\x00'):
...
def Proc8(Array1Par: List[int], Array2Par: List[int], IntParI1, IntParI2):
    global IntGlob
    IntLoc = IntParI1 + 5
