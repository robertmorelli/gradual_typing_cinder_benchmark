...
def create_array(start: int64, end: int64, step: int64):
    ...
    size = box(int64(int64((int64(static_abs(end - start)) - 1) / int64(static_abs(step)) + 1)))
    a = Array[int64](size)
    while i < int64(size):
        a[i] = int64(c)
...
def permutations(pool: Array[int64], r=-1):
    ...
    if int64(r) == -1:
        r = box(n)
    rb = r
    indices: Array[int64] = cast(Array[int64], create_array(0, n, 1))
    cycles: Array[int64] = cast(Array[int64], create_array(n, n - int64(r), -1))
