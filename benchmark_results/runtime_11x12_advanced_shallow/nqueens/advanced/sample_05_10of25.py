...
def create_array(start, end: int64, step: int64):
    """
    ...
    size = box(int64(int64((static_abs(end - int64(start)) - 1) / static_abs(step) + 1)))
...
def permutations(pool: Array[int64], r: int64=-1) -> Iterator[Array[int64]]:
    ...
    cycles = cast(Array[int64], create_array(box(int64(n)), n - r, -1))
    per = Array[int64](rb)
    idx = box(int64(0))
    while int64(idx) < r:
