...
def create_array(start, end: int64, step: int64) -> Array[int64]:
    """
    ...
    c: int64 = int64(start)
    i: int64 = 0
    if (end - int64(start)) * step <= 0:
        return Array[int64](0)
    size: int64 = int64((int64(static_abs(end - int64(start))) - 1) / int64(static_abs(box(int64(step)))) + 1)
...
def permutations(pool: Array[int64], r=-1) -> Iterator[Array[int64]]:
    ...
    cycles: Array[int64] = create_array(box(int64(n)), n - int64(r), -1)
    per = Array[int64](rb)
    idx = box(int64(0))
