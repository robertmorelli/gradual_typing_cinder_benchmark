...
def create_array(start: int64, end: int64, step) -> Array[int64]:
    """
    ...
    size = box(int64(int64((int64(static_abs(end - start)) - 1) / int64(static_abs(int64(step))) + 1)))
    a = Array[int64](size)
...
def permutations(pool: Array[int64], r: int64=-1) -> Iterator[Array[int64]]:
    ...
    cycles = create_array(n, n - r, box(int64(-1)))
