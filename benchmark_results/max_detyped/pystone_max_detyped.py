...
Array2Glob = CheckedList[CheckedList[int]](CheckedList[CheckedList[int]]([CheckedList[int](x) for x in [CheckedList[int](Array1Glob)] * 51]))
...
def Proc0(loops=LOOPS):
    ...
    CheckedList[CheckedList[int]](Array2Glob)[8][7] = 10
    for _i in range(loops):
        Proc5()
        Proc4()
        IntLoc1 = 2
        ...
        while IntLoc1 < IntLoc2:
            ...
            IntLoc1 = IntLoc1 + 1
        Proc8(CheckedList[int](Array1Glob), CheckedList[CheckedList[int]](Array2Glob), IntLoc1, IntLoc3)
