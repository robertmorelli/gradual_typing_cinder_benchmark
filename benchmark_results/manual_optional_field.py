...
class Constraint(object):
    ...
    def satisfy(self, mark: int64) -> Constraint | None:
        ...
        out = self.output()
        overridden = cast(Constraint | None, cast(Constraint, out.determined_by))
...
class BinaryConstraint(Constraint):
    ...
    def inputs_known(self, mark: int64) -> cbool:
        i = self.input()
        return i.mark == mark or i.stay or cbool(cast(Constraint | None, cast(Constraint, i.determined_by)) is None)
...
class Variable(object):
    ...
    def remove_constraint(self, constraint: Constraint) -> None:
        ...
        if cast(Constraint | None, cast(Constraint, self.determined_by)) == constraint:
...
class Planner(object):
    ...
    def remove_propagate_from(self, out: Variable) -> CheckedList[Constraint]:
        ...
        while len(todo):
            ...
            determining = cast(Constraint | None, cast(Constraint, v.determined_by))
            for c in cs:
