...
class Strength:
    ...
    def next_weaker(self) -> Strength:
        return cast(Strength, cast(CheckedList[Strength], STRENGTHS)[box(self.strength)])
...
class UrnaryConstraint(Constraint):
    ...
    def recalculate(self):
        ...
        self.my_output.stay = box(not cbool(self.is_input()))
...
class Planner(object):
    ...
    def add_constraints_consuming_to(self, v, coll) -> None:
        ...
        cc: CheckedList[Constraint] = cast(CheckedList[Constraint], v.constraints)
        for c in cc:
            if c != determining and c.is_satisfied():
                coll.append(c)
