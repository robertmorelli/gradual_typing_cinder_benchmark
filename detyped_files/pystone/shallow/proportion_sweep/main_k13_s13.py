...
def Proc0(loops=LOOPS):
    ...
    for _i in range(loops):
        ...
        while IntLoc1 < IntLoc2:
            ...
            IntLoc1 = IntLoc1 + 1
        Proc8(cast(List[int], Array1Glob), cast(List[int], Array2Glob), IntLoc1, IntLoc3)
...
def Proc8(_Array1Par, _Array2Par, IntParI1, IntParI2):
    Array1Par: List[int] = cast(List[int], _Array1Par)
    Array2Par: List[int] = cast(List[int], _Array2Par)
    global IntGlob
    IntLoc = IntParI1 + 5
