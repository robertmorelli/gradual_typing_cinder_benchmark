...
def _repro_Proc8_arg0_arg1(f, arg0, arg1, arg2, arg3):
    _arg0 = CheckedList[int](arg0)
    _arg1 = CheckedList[CheckedList[int]](arg1)
    _out = f(_arg0, _arg1, arg2, arg3)
    arg0.clear()
    arg0.extend(_arg0)
    arg1.clear()
    arg1.extend(_arg1)
...
def Proc0(loops=LOOPS):
    ...
    for _i in range(loops):
        ...
        while IntLoc1 < IntLoc2:
            ...
            IntLoc1 = IntLoc1 + 1
        _repro_Proc8_arg0_arg1(Proc8, Array1Glob, Array2Glob, IntLoc1, IntLoc3)
        PtrGlb = cast(Record, Proc1(cast(Record, local_PtrGlb)))
        local_PtrGlb = PtrGlb
        assert local_PtrGlb is not None
        CharIndex: str = 'A'
...
def Proc1(_PtrParIn):
    PtrParIn: Record = cast(Record, _PtrParIn)
    local_PtrGlb = PtrGlb
    assert local_PtrGlb is not None
...
def Proc3(_PtrParOut):
    PtrParOut: Record | None = cast(Record | None, _PtrParOut)
    global IntGlob
    global PtrGlb
    local_PtrGlb = PtrGlb
    assert local_PtrGlb is not None
...
def Proc8(Array1Par, Array2Par, IntParI1, IntParI2):
    Array1Par = cast(CheckedList[int], Array1Par)
    Array2Par = cast(CheckedList[CheckedList[int]], Array2Par)
    global IntGlob
    IntLoc = IntParI1 + 5
