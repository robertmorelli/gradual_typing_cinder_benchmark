...
def create_array(_start, _end, _step):
    ...
    size: int64 = int64(int64((int64(static_abs(box(int64(end - start)))) - 1) / int64(static_abs(box(int64(step)))) + 1))
    a = cast(Array[int64], Array[int64](box(size)))
    while i < size:
        a[i] = c
        c = c + step
        i = i + 1
...
def permutations(_pool, _r=-1):
    ...
    if r == -1:
        r = n
    rb = box(r)
    indices = cast(Array[int64], cast(Array[int64], create_array(box(int64(0)), box(int64(n)), box(int64(1)))))
    cycles = cast(Array[int64], cast(Array[int64], create_array(box(int64(n)), box(int64(n - r)), box(int64(-1)))))
...
def solve(queen_count):
    ...
    static_cols = cast(Array[int64], cast(Array[int64], create_array(box(int64(0)), box(int64(int64(queen_count))), box(int64(1)))))
